 ...
 */
// app.use(
//   require("../../CommonLibrary/api/helpers/auditLog.helper").handleAuditLog
// );

/**
 * Routes
 */
app.use('/UserManagement/', require('./api/route')); // Version 1
...
getSecretKey(SECRET_KEYS.USER_MANAGEMENT_SERVICE_URL).then((res) => {
  console.log("res", res);
