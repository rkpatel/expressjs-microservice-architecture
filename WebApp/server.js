 ...
 * Audit Log Handling
 */
app.use(require('./api/helpers/auditLog.helper').handleAuditLog);
/**
 * Routes
 */
app.use('/webapp/api/', require('./api/route')); // Version 1
 ...
 */
app.use(require('../CommonLibrary/api/helpers/error.helper').handleJoiErrors);
...
getSecretKey(SECRET_KEYS.MAIN_API).then(res => {
  console.log('res', res);
